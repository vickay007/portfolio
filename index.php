...
<body>
	...
	<header id="header">
			...
			<div class="row height-90 align-items-center justify-content-center">
				<div class="col">
					<div class="banner text-center">
						<h1 class="text-capitalize w-50 mx-auto">
							<small>sushi</small> <strong class="primary-color">monstar</strong>
						</h1>
		...
		<a href="#special-items" class="btn primary-color header-link"><i class="fas fa-arrow-down"></i></a>
	</header>
	...
	<nav class="navbar navbar-expand-lg">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="navbar-nav mx-auto">
				...
				<li class="nav-item">
					<a href="#review" class="nav-link text-capitalize">reviews</a>
				</li>
			...
			<form class="form-inline d-none d-lg-block mr-5">
				<button type="button" class="btn nav-btn text-capitalize">order online</button>
			</form>
		</div>
	</nav>
			...
			<div class="row parent-container">
				...
				<div class="col-10 mx-auto col-sm-6 col-lg-4 my-3">
					<div class="item-container">
						<img src="images/sushi2.jpeg" class="img-fluid img-thumbnail item-img" alt="menu-item">
						<a href="images/sushi2.jpeg">
							<h3 class="text-uppercase text-center item-link px-3">menu item</h3>
						</a>
					</div>	
				</div>
				...
				<div class="col-10 mx-auto col-sm-6 col-lg-4 my-3">
					<div class="item-container">
						<img src="images/sushi3.jpeg" class="img-fluid img-thumbnail item-img" alt="menu-item">
						<a href="images/sushi3.jpeg">
							<h3 class="text-uppercase text-center item-link px-3">menu item</h3>
						</a>
					</div>
				</div>
				...
				<div class="col-10 mx-auto col-sm-6 col-lg-4 my-3">
				<div class="item-container">
						<img src="images/sushi4.jpeg" class="img-fluid img-thumbnail item-img" alt="menu-item">
						<a href="images/sushi4.jpeg">
							<h3 class="text-uppercase text-center item-link px-3">menu item</h3>
						</a>
					</div>		
				</div>
				...
				<div class="col-10 mx-auto col-sm-6 col-lg-4 my-3">
					<div class="item-container">
						<img src="images/sushi6.jpeg" class="img-fluid img-thumbnail item-img" alt="menu-item">
						<a href="images/sushi6.jpeg">
							<h3 class="text-uppercase text-center item-link px-3">menu item</h3>
						</a>
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 my-4">
					...
					<h2 class="text-muted"> ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
				...
				<div class="col-md-6 about-pictures my-4 d-none d-lg-block">
					<img src="images/sushi4.jpeg" alt="menu" class="img-1 img-thumbnail about-img">
					<img src="images/sushi5.jpeg" alt="menu" class="img-2 img-thumbnail about-img">
					<img src="images/sushi6.jpeg" alt="menu" class="img-3 img-thumbnail about-img">
					<img src="images/sushi3.jpeg" alt="menu" class="img-4 img-thumbnail about-img">
					<img src="images/sushi2.jpeg" alt="menu" class="img-5 img-thumbnail about-img">
				</div>
			</div>
		</div>
	</section>
						...
						<div class="row">
							<div class="col-lg-10 mx-auto d-flex justify-content-between review-item py-3">
								...
								<div class="align-self-center ml-3">
									<img src="images/customer3.jpg" class="rounded-circle review-img">
								</div>
								<!-- text -->
								<div class="review-text px-5">
									<h2 class="text-capitalize mb-3 primary-color">customer name</h2>
									<p class="leat text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-10 mx-auto d-flex justify-content-between review-item py-3">
								<!-- image -->
								<div class="align-self-center ml-3">
									<img src="images/customer2.jpg" class="rounded-circle review-img">
								</div>
								<!-- text -->
								<div class="review-text px-5">
									<h2 class="text-capitalize mb-3 primary-color">customer name</h2>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-9 col-sm-6 col-lg-4 mx-auto my-4">
					<div class="card">
						<img src="images/team2.jpg" class="card-img-top img-fluid">
						<div class="card-body">
							<div class="card-title">
								<h2 class="text-capitalize">team member</h2>
							</div>
			...
			<div class="row">
				<div class="col-md-6 my-3">
					<div class="embed-responsive embed-responsive-21by9 height-60">
						<iframe class="embed-responsive-item" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d380513.7160135902!2d-88.01214970001703!3d41.83339250031485!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880e2c3cd0f4cbed%3A0xafe0a6ad09c0c000!2sChicago%2C%20IL%2C%20USA!5e0!3m2!1sen!2sng!4v1593086765919!5m2!1sen!2sng" width="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
					</div>
				</div>
				<div class="col-md-6 my-3 align-self-center">
					<div class="card text-center">
						<div class="card-header">
							<h2 class="text-uppercase">contact list</h2>
						</div>
						<div class="card-body">
							<form>
								<!-- input group -->
								<div class="input-group my-3">
									...
									<input type="text" class="form-control form-control-lg" id="text" placeholder="Enter your name here">
								</div>
								...
								<div class="input-group my-3">
									...
									<input type="text" class="form-control form-control-lg" id="phone" placeholder="Enter your phone here">
								</div>
